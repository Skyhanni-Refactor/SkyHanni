...
public class GhostCounterConfig {
    ...
    public enum GhostDisplayEntry {
        TITLE("§6Ghosts Counter"),
        GHOSTS_KILLED("  §bGhost Killed: 42"),
        SORROW("  §bSorrow: 6"),
        GHOST_SINCE_SORROW("  §bGhost since Sorrow: 1"),
        GHOST_PER_SORROW("  §bGhosts/Sorrow: 5"),
        VOLTA("  §bVolta: 6"),
        PLASMA("  §bPlasma: 8"),
        GHOSTLY_BOOTS("  §bGhostly Boots: 1"),
        BAG_OF_CASH("  §bBag Of Cash: 4"),
        AVG_MAGIC_FIND("  §bAvg Magic Find: 271"),
        SCAVENGER_COINS("  §bScavenger Coins: 15,000"),
        KILL_COMBO("  §bKill Combo: 14"),
        HIGHEST_KILL_COMBO("  §bHighest Kill Combo: 96"),
        SKILL_XP_GAINED("  §bSkill XP Gained: 145,648"),
        BESTIARY("  §bBestiary 1: 0/10"),
        XP_PER_HOUR("  §bXP/h: 810,410"),
        KILLS_PER_HOUR("  §bKills/h: 420"),
        ETA("  §bETA: 14d"),
        MONEY_PER_HOUR("  §bMoney/h: 13,420,069"),
        MONEY_MADE("  §bMoney made: 14B"),
        ;
